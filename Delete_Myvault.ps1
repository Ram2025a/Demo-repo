...
$VaultName = "Myvault" #fetch automatically
$Subscription = "MSDN Platforms Subscription" #fetch automatically
$ResourceGroup = "myapprg" #fetch automatically
$SubscriptionId = "254fc39b-c667-436b-80a7-f0dc7038e484" #fetch automatically
